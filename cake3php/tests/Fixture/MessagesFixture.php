...
class MessagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'body' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_at' => '2024-03-01 15:31:36',
                'updated_at' => '2024-03-01 15:31:36',
                'user_id' => 1,
                'category_id' => 1,
            ],
        ];
